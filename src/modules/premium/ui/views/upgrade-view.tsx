...
export const UpgradeView = () => {
    ...
    console.log("this are your products", products)
    // console.log("Product metadata", products.metadata)
    return (
        <div className="flex-1 py-4 px-4 md:px-8 flex flex-col gap-y-10">
            <div className="mt-4 flex-1 flex flex-col gap-y-10 items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {products.length === 0 ? "Nothing is there" : (
...
export const UpgradeViewError = () => (
    <ErrorState title="Error occurred" description="Something went wrong with the meetings" />
);
